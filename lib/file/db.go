...
func GetMapKeys(m sync.Map, isSort bool, sortKey, order string) (keys []int64) {
	if sortKey != "" && isSort {
...
//
//func (s *DbUtils) GetClientList(start, length int, search, sort, order string, clientId int64) ([]*Client, int) {
//	list := make([]*Client, 0)
//	var cnt int
...
//				continue
//			}
//			if search != "" && !(v.Id == common.GetInt64NoErrByStr(search) || strings.Contains(v.VerifyKey, search) || strings.Contains(v.Remark, search)) {
//				continue
//			}
//			cnt++
//			if start--; start < 0 {
...
//		v := value.(*Client)
//		if common.Getverifyval(v.VerifyKey) == vKey && v.Status==1{
...
//
//func (s *DbUtils) DelHost(id int64) error {
...
//}
//
//func (s *DbUtils) GetHost(start, length int, id int64, search string) ([]*Host, int) {
//	list := make([]*Host, 0)
//	var cnt int
...
//			v := value.(*Host)
//			if search != "" && !(v.Id == common.GetInt64NoErrByStr(search) || strings.Contains(v.Host, search) || strings.Contains(v.Remark, search)) {
//				continue
//			}
...
//	}
//	if c.Id == 0 {
//		//c.Id = int64(s.JsonDb.GetClientId())
//	}
//	if c.Flow == nil {
//		c.Flow = new(Flow)
//	}
...
//}
//
//func (s *DbUtils) GetClient(id int64) (c *Client, err error) {
